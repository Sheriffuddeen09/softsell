    ...
    const content =  (
        <div className="bg-profile flex flex-col sm:w-96 w-72 justify-center items-center ">
            ...
            key={user.profile_image} />}
             <h2 className="text-black mt-4 font-bold text-sm hover:text-blue-500 cursor-pointer" onClick={handleView}>Edit Profile</h2>
            ...
            <div className={`fixed trans top-0 flex justify-center items-center right-0 w-full h-full ${viewEdit ? "block" : 'hidden'}`}>
            <div className={`sm:w-5/12 w-72 bg-white flex flex-col justify-center items-center h-96 rounded-xl `}>
            <div className=" pb-4 px-2 rounded-xl mb-5">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 relative sm:-top-20 top-0 cursor-pointer  sm:left-96 left-60" onClick={handleView}>
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
            </svg>
        <div className="flex flex-row flex-wrap justify-around gap-3 sm:gap-5 ">
...
cursor-pointer my-3 items-center border border border-black p-4 rounded-lg" onClick={handleuserinfo}>
            ...
            <div className="flex flex-col justify-center my-3 cursor-pointer

        ...
        {loading ? (
          ...
          filteredCart.map((car) =>(
            ...
            <p className="width-des md:translate-x-0 lg:translate-x-28">{car.maintenance}</p>
                  ...
                  <p className="text-center font-bold text-xl my-32 flex justify-center gap-3 items-center">No Cart to display <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
